...
QT_MOC_LITERAL(1, 7, 15), // "newTabRequested"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 17), // "closeTabRequested"
QT_MOC_LITERAL(4, 42, 5), // "index"
QT_MOC_LITERAL(5, 48, 20), // "closeOthersRequested"
QT_MOC_LITERAL(6, 69, 21), // "closeToRightRequested"
QT_MOC_LITERAL(7, 91, 17) // "copyPathRequested"

    },
    "TabBar\0newTabRequested\0\0closeTabRequested\0"
    "index\0closeOthersRequested\0"
    "closeToRightRequested\0copyPathRequested"
};
...
void TabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->closeTabRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->closeOthersRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->closeToRightRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->copyPathRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabBar::closeTabRequested)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (TabBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabBar::copyPathRequested)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 1
void TabBar::closeTabRequested(int _t1)
{
...
// SIGNAL 4
void TabBar::copyPathRequested(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
