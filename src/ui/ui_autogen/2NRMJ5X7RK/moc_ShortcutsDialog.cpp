...
QT_MOC_LITERAL(1, 16, 16), // "onSequenceEdited"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 3), // "row"
QT_MOC_LITERAL(4, 38, 15) // "restoreDefaults"

    },
    "ShortcutsDialog\0onSequenceEdited\0\0row\0"
    "restoreDefaults"
};
...
void ShortcutsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onSequenceEdited((*reinterpret_cast< int(*)>(_a[1]))); break;
...
QT_INIT_METAOBJECT const QMetaObject ShortcutsDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ShortcutsDialog.data,
    qt_meta_data_ShortcutsDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
