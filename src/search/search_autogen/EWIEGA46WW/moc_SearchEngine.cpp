...
QT_MOC_LITERAL(3, 22, 11), // "resultFound"
QT_MOC_LITERAL(4, 34, 4), // "path"
QT_MOC_LITERAL(5, 39, 8) // "finished"

    },
    "SearchEngine\0started\0\0resultFound\0"
    "path\0finished"
};
...
void SearchEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->resultFound((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchEngine::started)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchEngine::resultFound)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SearchEngine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchEngine::finished)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SearchEngine::started()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SearchEngine::resultFound(const QString & _t1)
{
